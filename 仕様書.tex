...
\begin{align}
  \left<P\right> &= \frac{1}{\pi d^2} \int_0^{d} 2 \pi \left<\frac{dN}{da}\right>_{\psi} P(a) \, da. \label{eq:Pd1}
\end{align}
...
\begin{align}
  \left<P_{\mathrm{att}}\right> &= \frac{1}{V} \int_V P(a, z) \, dV = \frac{1}{\pi d^2} \int_0^d 2 \pi P_{\mathrm{att}}(a) \left<\frac{dN}{da}\right>_{\psi} \, da \label{eq:P-aveaz}
\end{align}
...
これの$\theta $に関する平均化を行う。
\begin{equation}
  \left< \frac{dP}{dt} \right>_\theta = \int_{0}^{\pi/2}\sin \theta \frac{dP(a, z)}{dt} d\theta = \frac{c'}{2 \pi} \int_{0}^{\pi/2} \int_{\Phi(\theta)} \sin \theta \frac{\cos^2\theta}{L-z} d \phi d\theta = c' \int_{0}^{\pi/2} \frac{\cos^2\theta}{L-z} \frac{dP(a, \theta)}{d\theta} d\theta
